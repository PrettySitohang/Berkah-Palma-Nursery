...
import { FiSearch, FiSliders, FiEdit2, FiTrash2, FiMenu, FiUser } from 'react-icons/fi';
...
export default function ManajemenBibit() {
  ...
  return (
    <div 
      ...
      style={{ backgroundImage: `url('/img/fotobibitsawit.png')` }}
    >
      ...
      <div className="relative z-20">
        ...
        <div className="bg-[#294D29] text-white rounded-bl-[60px] rounded-br-none shadow-md relative z-30 pb-20">
          ...
          {/* 🟢 NAVBAR ATAS BARU (Menu, Logo, Profil) */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
            ...
            <div className="flex items-center gap-2">
              {/* Lingkaran Logo Berkah Palma */}
              <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center font-bold text-[#294D29] text-xs shadow-sm overflow-hidden">
                <img 
                  src="/img/LogoBerkahPalma.png" 
                  alt="Logo Berkah Palma" 
                  className="w-full h-full object-cover"
                />
              </div>
              <span className="font-bold tracking-wider text-sm">BERKAH PALMA</span>
            </div>
