...
const FormBibit = lazy(() => import('./pages/admin/FormBibit'));
const ManajemenAkun = lazy(() => import('./pages/admin/ManajemenAkun'));
const FormAkun = lazy(() => import('./pages/admin/FormAkun'));
    ...
    <Suspense fallback={<Loading />}>
      <Routes>
        ...
        <Route path="/admin" element={<MainLayout />}>
          ...
          <Route path="bibit/form" element={<FormBibit />} />
          
          <Route path="akun" element={<ManajemenAkun />} />
          <Route path="akun/form" element={<FormAkun />} />
        </Route>
