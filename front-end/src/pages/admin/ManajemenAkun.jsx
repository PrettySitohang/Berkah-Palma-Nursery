  ...
  return (
    <div className="min-h-screen relative font-sans text-slate-800 pb-20 overflow-hidden" style={{ fontFamily: '"Poppins", sans-serif' }}>
      ...
      <div className="relative z-10">
        ...
        {/* HEADER */}
        <div className="bg-[#294D29] rounded-bl-[3.5rem] px-6 pt-10 pb-10 text-white shadow-xl">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex justify-between items-end">
              ...
              <button 
                ...
                className="bg-[#8ec28b] hover:bg-[#7ab077] active:scale-95 text-[#1e3223] font-bold text-sm py-2.5 px-5 rounded-xl transition-all shadow-lg flex items-center gap-2 cursor-pointer"
              >
